...
module DevEnv
  class Config
    ...
    # Returns the listening socket so the port stays claimed while an
    # environment is prepared; the caller closes it immediately before
    # starting the service that binds the port.
